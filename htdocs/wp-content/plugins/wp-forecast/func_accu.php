...
if (!function_exists('accu_xml_parser')) {
	...
	function accu_forecast_data($wpfcid = "A", $language_override = null) {
		...
		if (!isset($w['failure'])) { 
            # determine link to accuweather service for location
            if ( is_numeric($location) )
                $weather_arr['servicelink'] = 'http://www.accuweather.com/quick-look.aspx?partner=accuweather&amp;loc=' . $locname . '&amp;metric=' . $metric;
            else
