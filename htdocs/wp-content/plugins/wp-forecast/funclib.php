...
/*  Copyright 2006-2020 Hans Matzen (email : webmaster at tuxlog dot de)
...
{ 
	$dir = "-";
	if (      0 <= $wdir ) $dir="N";
	if (  11.25 <= $wdir ) $dir="NNE";
	if (  33.75 <= $wdir ) $dir="NE";
	if (  56.25 <= $wdir ) $dir="ENE";
	if (  78.75 <= $wdir ) $dir="E";
	if ( 101.25 <= $wdir ) $dir="ESE";
	if ( 123.75 <= $wdir ) $dir="SE";
	if ( 146.25 <= $wdir ) $dir="SSE";
	if ( 168.75 <= $wdir ) $dir="S";
	if ( 191.25 <= $wdir ) $dir="SSW";
	if ( 213.75 <= $wdir ) $dir="SW";
	if ( 236.25 <= $wdir ) $dir="WSW";
	if ( 258.75 <= $wdir ) $dir="W";
	if ( 281.25 <= $wdir ) $dir="WNW";
	if ( 303.75 <= $wdir ) $dir="NW";
	if ( 326.25 <= $wdir ) $dir="NNW";
	if ( 348.75 <= $wdir ) $dir="N";
