...
function freeaustralia_html5map_plugin_scripts(){
    if ( is_admin() ){
        ...
        wp_register_style('freeaustralia-html5-map-adm', plugins_url('/static/css/mapadm.css', __FILE__), array(), '3.1.9');
        wp_enqueue_style('freeaustralia-html5-map-adm');
        wp_register_style('freeaustralia-html5-map-style', plugins_url('/static/css/map.css', __FILE__), array(), '3.1.9');
...
function freeaustralia_html5map_plugin_content($atts, $content) {
    ...
    wp_register_script('raphaeljs', freeaustralia_html5map_plugin_get_raphael_js_url(), array(), '3.1.9');
    wp_register_script('freeaustralia-html5-map-mapjs_'.$type_id, freeaustralia_html5map_plugin_get_map_js_url($options), array('raphaeljs'), '3.1.9');
    ...
    if ($options['useAjaxUrls']) {
        ...
        $stateInfoUrl = "{$siteURL}/index.php?map_id={$map_id}&freeaustraliahtml5map_get_state_info=";
        $groupInfoUrl = "{$siteURL}/index.php?map_id={$map_id}&freeaustraliahtml5map_get_group_info=";
    }
